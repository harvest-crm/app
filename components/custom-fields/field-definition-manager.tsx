    ...
    <div>
      ...
      <div className="mb-4 flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-1.5 rounded-md bg-[#1F8A8A] px-3 py-1.5 text-sm font-semibold text-white hover:bg-[#1A7575]"
        >
              ...
              <div key={def.id} className="flex items-center gap-3 px-4 py-3">
                ...
                <div className="flex flex-col">
                  <button
                    ...
                    onClick={() => moveUp(idx)}
                    disabled={idx === 0}
                    className="rounded p-0.5 text-[#3D5775] hover:text-[#3D5775] disabled:opacity-20"
                  >
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2">
                    <span className="text-sm font-medium text-[#0F2540]">{def.fieldLabel}</span>
                    {def.isRequired && (
                      <span className="rounded-full bg-red-100 px-1.5 py-0.5 text-xs font-semibold text-red-600">
                        Required
                      </span>
                    )}
                    <span className="rounded bg-[#E2F0EE] px-1.5 py-0.5 text-xs text-[#3D5775]">
                ...
                {isDeleting ? (
                  ...
                  <div className="flex shrink-0 items-center gap-1">
                    <button
                      ...
                      className="rounded p-1.5 text-[#3D5775] hover:bg-[#E2F0EE] hover:text-[#3D5775]"
                    >
                    ...
                    <button
                      ...
                      className="rounded p-1.5 text-[#3D5775] hover:bg-red-100 hover:text-red-600"
                    >
      ...
      {defs.length === 0 && (
        <div className="rounded-xl border-2 border-dashed border-[#E8DFC8] p-10 text-center">
          <p className="text-sm text-[#3D5775]">
            No {tab === "contact" ? "contact" : "deal"} fields yet.
          </p>
          <p className="mt-1 text-xs text-[#3D5775]">
