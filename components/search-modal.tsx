      ...
      <div className="w-full max-w-lg overflow-hidden rounded-xl bg-white shadow-2xl ring-1 ring-black/10">
        ...
        <div className="flex items-center gap-3 border-b px-4">
          ...
          <input
            ...
            className="flex-1 py-4 text-sm text-slate-800 outline-none placeholder:text-slate-400"
          />
          {loading ? (
                  ...
                  {items.map((item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {highlighted && (
                          <kbd className="shrink-0 rounded bg-slate-100 px-1.5 py-0.5 text-xs text-slate-400">
                            ↵
                          </kbd>
                        )}
                      </button>
        ...
        {results && sections.length > 0 && (
          <div className="flex items-center gap-4 border-t px-4 py-2 text-xs text-slate-400">
            <span><kbd className="rounded bg-slate-100 px-1 py-0.5">↑↓</kbd> navigate</span>
            <span><kbd className="rounded bg-slate-100 px-1 py-0.5">↵</kbd> open</span>
