    ...
    <div className="space-y-3">
      <div className="space-y-1.5">
        {contactWorkspaces.map((cw) => (
          <div key={cw.workspaceId} className="flex items-center justify-between rounded-md bg-slate-50 px-2.5 py-1.5 text-sm">
        ...
        {contactWorkspaces.length === 0 && (
          <span className="text-xs text-slate-400">Not in any workspace</span>
        )}
      </div>
